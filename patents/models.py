...
class pt_main(models.Model):
    ...
    parentappnumber = models.IntegerField(null=True)
...
class pt_priority_claim(models.Model):
    ...
    foreignappnumber = models.TextField(null=True)
    priorityclaimkindcode= models.CharField(max_length=15, null=True) # subject to change
