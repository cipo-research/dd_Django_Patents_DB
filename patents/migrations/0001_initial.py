# Generated by Django 4.2.5 on 2023-09-13 18:59
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            options={
                'indexes': [django.contrib.postgres.indexes.GinIndex(fields=['search_vector'], name='patents_pt__search__a861b6_gin')],
            },
        ),
        migrations.CreateModel(
            ...
            options={
                'indexes': [django.contrib.postgres.indexes.GinIndex(fields=['search_vector'], name='patents_pt__search__785a99_gin')],
            },
        ),
        migrations.CreateModel(
            ...
            options={
                'indexes': [django.contrib.postgres.indexes.GinIndex(fields=['search_vector'], name='patents_pt__search__30ee24_gin')],
            },
        ),
        migrations.CreateModel(
            name='pt_disclosure',
            ...
            options={
                'indexes': [django.contrib.postgres.indexes.GinIndex(fields=['search_vector'], name='patents_pt__search__bb6434_gin')],
            },
        ),
        migrations.CreateModel(
            name='pt_claim',
            ...
            options={
                'indexes': [django.contrib.postgres.indexes.GinIndex(fields=['search_vector'], name='patents_pt__search__612671_gin')],
            },
        ),
        migrations.CreateModel(
            name='pt_abstract',
            ...
            options={
                'indexes': [django.contrib.postgres.indexes.GinIndex(fields=['search_vector'], name='patents_pt__search__7b4f93_gin')],
            },
        ),
    ]
